...
forwardTextureCoordinates();`),b.include(i.HQ,o),e.include(v.S,o),e.include(u.Q,o),b.main.add(f.H`
        ...
        ${(0,f.If)(y,f.H`vec4 texColor = texture(tex, ${O?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
        calculateOcclusionAndOutputHighlight();`)}}},22148:(e,o,t)=>{t.d(o,{K:()=>l});var a=t(59581),r=t(86955),i=t(72790),n=t(66470),s=t(99362);function l(e,o){o.hasSymbolColors?(e.include(a.A),e.attributes.add(n.r.SYMBOLCOLOR,"vec4"),e.varyings.add("colorMixMode","mediump float"),e.vertex.code.add(r.H`int symbolColorMixMode;
vec4 getSymbolColor() {
...
void forwardColorMixMode() {}`))}},27920:(e,o,t)=>{t.d(o,{W:()=>a,r:()=>n});var a,r=t(4212),i=t(86955);function n(e,o){const t=e.fragment;switch(t.code.add(i.H`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
return gl_FrontFacing ? normalize(params.normalView) : normalize(-params.normalView);
  ...
  `),e.outputs.add("fragBlur","float"),o.main.add(s.H`
    ...
    fragBlur = b / w_total;`),e}const h=Object.freeze(Object.defineProperty({__proto__:null,build:u},Symbol.toStringTag,{value:"Module"}))},34260:(e,o,t)=>{t.d(o,{b:()=>r});var a=t(86955);function r(e,o){o.snowCover&&(e.code.add(a.H`float getSnow(vec3 normal, vec3 normalGround) {
...
return mix(emission, vec4(0.0), snow);
  ...
  `)}},45937:(e,o,t)=>{t.d(o,{B:()=>b});var a=t(63919),r=t(44680),i=t(13191),n=t(20664),s=t(9392),l=t(34981),c=t(89299),d=t(42451),m=t(84115),u=t(86955),h=t(72106),v=t(43425),p=t(66470),f=t(99643),g=t(31432);g.Y;const x=(0,r.vt)();function b(e,o){const{hasModelTransformation:t,instancedDoublePrecision:r,instanced:s,output:g,hasVertexTangents:b}=o;t&&(e.vertex.uniforms.add(new v.X("model",e=>e.modelTransformation??i.zK)),e.vertex.uniforms.add(new h.k("normalLocalOriginFromModel",e=>((0,a.Ge)(x,e.modelTransformation??i.zK),x)))),s&&r&&(e.attributes.add(p.r.INSTANCEMODELORIGINHI,"vec3"),e.attributes.add(p.r.INSTANCEMODELORIGINLO,"vec3"),e.attributes.add(p.r.INSTANCEMODEL,"mat3"),e.attributes.add(p.r.INSTANCEMODELNORMAL,"mat3"));const M=e.vertex;r&&(M.include(c.u,o),M.uniforms.add(new m.d("viewOriginHi",e=>(0,f.Zo)((0,n.i)(w,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),w)),new m.d("viewOriginLo",e=>(0,f.jA)((0,n.i)(w,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),w)))),M.code.add(u.H`
    ...
    }`)}const w=(0,s.vt)()},49399:(e,o,t)=>{t.d(o,{L:()=>i});var a=t(34981),r=t(86955);function i(e,o){switch(o.output){case a.V.Shadow:case a.V.ShadowHighlight:case a.V.ShadowExcludeHighlight:case a.V.ViewshedShadow:e.fragment.code.add(r.H`float _calculateFragDepth(const in float depth) {
...
}`)}}},50819:(e,o,t)=>{t.d(o,{W:()=>m});var a=t(20664),r=t(9392),i=t(43047),n=t(55855),s=t(26719),l=t(84115),c=t(51596),d=t(86955);function m(e,o){const t=e.fragment,r=void 0!==o.lightingSphericalHarmonicsOrder?o.lightingSphericalHarmonicsOrder:2;0===r?(t.uniforms.add(new l.d("lightingAmbientSH0",e=>{let{lighting:o}=e;return(0,a.i)(u,o.sh.r[0],o.sh.g[0],o.sh.b[0])})),t.code.add(d.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):1===r?(t.uniforms.add(new c.I("lightingAmbientSH_R",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.r[0],o.sh.r[1],o.sh.r[2],o.sh.r[3])}),new c.I("lightingAmbientSH_G",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.g[0],o.sh.g[1],o.sh.g[2],o.sh.g[3])}),new c.I("lightingAmbientSH_B",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.b[0],o.sh.b[1],o.sh.b[2],o.sh.b[3])})),t.code.add(d.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):2===r&&(t.uniforms.add(new l.d("lightingAmbientSH0",e=>{let{lighting:o}=e;return(0,a.i)(u,o.sh.r[0],o.sh.g[0],o.sh.b[0])}),new c.I("lightingAmbientSH_R1",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.r[1],o.sh.r[2],o.sh.r[3],o.sh.r[4])}),new c.I("lightingAmbientSH_G1",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.g[1],o.sh.g[2],o.sh.g[3],o.sh.g[4])}),new c.I("lightingAmbientSH_B1",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.b[1],o.sh.b[2],o.sh.b[3],o.sh.b[4])}),new c.I("lightingAmbientSH_R2",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.r[5],o.sh.r[6],o.sh.r[7],o.sh.r[8])}),new c.I("lightingAmbientSH_G2",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.g[5],o.sh.g[6],o.sh.g[7],o.sh.g[8])}),new c.I("lightingAmbientSH_B2",e=>{let{lighting:o}=e;return(0,i.s)(h,o.sh.b[5],o.sh.b[6],o.sh.b[7],o.sh.b[8])})),t.code.add(d.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
}`)):e.vertex.code.add(i.H`void forwardMetallicRoughnessUV(){}`)}},59046:(e,o,t)=>{t.d(o,{W:()=>a,Y:()=>l});var a,r,i=t(4212),n=t(86955),s=t(66470);function l(e,o){switch(o.normalType){case a.Compressed:e.attributes.add(s.r.NORMALCOMPRESSED,"vec2"),e.vertex.code.add(n.H`vec3 decompressNormal(vec2 normal) {
...
}`);break;default:(0,i.Xb)(o.normalType);case a.COUNT:}}(r=a||(a={}))[r.Attribute=0]="Attribute",r[r.Compressed=1]="Compressed",r[r.ScreenDerivative=2]="ScreenDerivative",r[r.COUNT=3]="COUNT"},59581:(e,o,t)=>{t.d(o,{A:()=>i});var a=t(51990),r=t(86955);function i(e){e.vertex.code.add(r.H`
...
rawNormal.xy = (normalRotation * vec3(rawNormal.x, rawNormal.y, 1.0)).xy;`),t.code.add(c.H`return tangentSpace * rawNormal;
  ...
  `)}}}]);
//# sourceMappingURL=5131.4afddef0.chunk.js.map